...
- [ ] **CORP-01**: 实验可通过配置（CLI 参数或环境变量）指定语料根目录，默认文档中约定支持 **北燃热力宣传品采购归档资料** 的实际路径
- [ ] **CORP-02**: 生成语料清单（文件路径、格式、页数/大小哈希可选），运行前校验可读
- [ ] **CORP-03**: 提供「黄金统计」输出：原文字符数、表格数量（若可检测）、页数等，供覆盖完整率与表格保持率分母使用
